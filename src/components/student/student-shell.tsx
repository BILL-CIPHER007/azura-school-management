...
export function StudentShell({
  ...
  return (
    <div className="student-root min-h-screen bg-background lg:grid lg:grid-cols-[264px_1fr]">
      ...
      <div className="min-w-0">
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-border bg-surface/95 px-4 backdrop-blur sm:px-6 lg:px-8">
          <div className="min-w-0">
            <p className="truncate text-sm font-semibold text-text-primary">Área do aluno</p>
